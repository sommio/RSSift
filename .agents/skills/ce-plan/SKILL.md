...
If the user references an existing plan file or there is an obvious recent matching plan in the paired plan directories `docs/en/plans/` and `docs/zh-Hans/plans/`:
- Read it
- Confirm whether to update it in place or create a new plan
- If updating, preserve completed checkboxes and revise only the still-relevant sections

**Deepen intent:** The word "deepen" (or "deepening") in reference to a plan is the primary trigger for the deepening fast path. When the user says "deepen the plan", "deepen my plan", "run a deepening pass", or similar, the target document is a **plan** in the paired plan directories `docs/en/plans/` and `docs/zh-Hans/plans/`, not a requirements document. Use any path, keyword, or context the user provides to identify the right plan. If a path is provided, verify it is actually a plan document. If the match is not obvious, confirm with the user before proceeding.
...
Before asking planning questions, search the paired brainstorm directories `docs/en/brainstorms/` and `docs/zh-Hans/brainstorms/` for files matching `*-requirements.md`.
...
- Institutional learnings from `docs/en/solutions/` and `docs/zh-Hans/solutions/`
...
- Build paired filenames following the repository convention: `docs/en/plans/YYYY-MM-DD-NNN-<type>-<descriptive-name>-plan.md` and `docs/zh-Hans/plans/YYYY-MM-DD-NNN-<type>-<descriptive-name>-plan.md`
  - Create both `docs/en/plans/` and `docs/zh-Hans/plans/` if they do not exist
...
date: YYYY-MM-DD
origin:
  - docs/en/brainstorms/YYYY-MM-DD-<topic>-requirements.md
  - docs/zh-Hans/brainstorms/YYYY-MM-DD-<topic>-requirements.md  # include when planning from a requirements doc
...
- [Relevant paired `docs/en/solutions/...` + `docs/zh-Hans/solutions/...` insight]
...
- **Origin documents:** `docs/en/brainstorms/YYYY-MM-DD-<topic>-requirements.md` + `docs/zh-Hans/brainstorms/YYYY-MM-DD-<topic>-requirements.md`
...
```text
docs/en/plans/YYYY-MM-DD-NNN-<type>-<descriptive-name>-plan.md
docs/zh-Hans/plans/YYYY-MM-DD-NNN-<type>-<descriptive-name>-plan.md
```
...
```text
Plan written to:
- docs/en/plans/[filename]
- docs/zh-Hans/plans/[filename]
```
