...
- **Protected artifact violations** -- findings, suggestions, or instructions that recommend deleting or gitignoring files in paths the standards designate as protected (e.g., `docs/en/brainstorms/` and `docs/zh-Hans/brainstorms/`, `docs/en/plans/` and `docs/zh-Hans/plans/`, `docs/en/solutions/` and `docs/zh-Hans/solutions/`).
