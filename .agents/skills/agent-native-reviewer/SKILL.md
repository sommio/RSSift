...
| React Router + Hono | route modules, fetcher forms, client actions, navigation handlers | `tool()`/handler registries in Hono routes, MCP server definitions, tool manifests consumed by the app |
