...
Note that files in `docs/en/plans/`, `docs/zh-Hans/plans/`, `docs/en/solutions/`, and `docs/zh-Hans/solutions/` are compound-engineering pipeline artifacts created by `/ce:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
